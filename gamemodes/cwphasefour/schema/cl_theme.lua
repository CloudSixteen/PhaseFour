...
function THEME:CreateFonts()
	...
	surface.CreateFont("lab_BarText", {
	...
	surface.CreateFont("lab_BarTextAuto", {
...
function THEME:Initialize()
	...
	Clockwork.option:SetColor("basic_form_color_help", Color(186, 219, 230, 255));
	Clockwork.option:SetColor("basic_form_color", Color(26, 169, 192, 255));
